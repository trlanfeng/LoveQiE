...
public sealed class CityTileTheme : ScriptableObject
{
    ...
    [Tooltip("One terrain brush; 47 fixed-orientation Blob rules select corners automatically.")]
    public CitySidewalkRuleTile sidewalk;
    ...
    public bool IsConfigured => HasTiles(asphalt, 4) && sidewalk != null && sidewalk.m_TilingRules.Count == 47
